...
namespace BinaryReadWrite
{
    public static class BinaryReaderExtensions
    {
        ...
        public static Dictionary<T,V> ReadDictionary<T,V>(this Reader reader)
        {
            int length = reader.ReadInt();
            ...
            {
                // throw EndOfStream for consistency with ReadBlittable when out of data
                throw new EndOfStreamException($"Reader attempted to allocate an Dictionary<{typeof(T)},{typeof(V)}> with {length} elements, which is larger than the allowed limit of {Reader.AllocationLimit}.");
            }
